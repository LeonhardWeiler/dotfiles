...
return {
  ...
  config = function()
    ...
    -- Incremental Selection: im main-Branch nicht mehr enthalten, daher als
    -- schlanke eigene Umsetzung über die vim.treesitter-API. <C-Space> startet
    -- bzw. erweitert die Auswahl auf den Elternknoten, <BS> verkleinert sie.
    local incr = { stack = {} }
